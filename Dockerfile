FROM myrotvorets/node-build:latest@sha256:3446c9aba7e7e470bd401a6cd7d9f41d2ed861bedcd1ae322ab156ccfb508999 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:43a7e2df2437b0ca6e1f6cccbf56a0e46069503b0861635adfe3461b72680a10
USER root
WORKDIR /srv/service
RUN \
