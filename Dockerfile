FROM myrotvorets/node-build:latest@sha256:445af90c062e9703a067cb92b26590cfdf57556d022d2f5da2a517866f5bd891 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:8b84fb639baa0556bc3e819be14d5a3639dc03a2da116d7be36b682c9926a53a
USER root
WORKDIR /srv/service
RUN \
