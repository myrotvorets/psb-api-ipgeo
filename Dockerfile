FROM myrotvorets/node-build:latest@sha256:384e6d8ec14af2fac0b4f9d1934fa624ef2ea7e3460d1b1b394d20012e0e739f AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:893bac04a82c9f2a4a51b5560c04747d6776c1195427c82dd47cb3f7814818c4
USER root
WORKDIR /srv/service
RUN \
