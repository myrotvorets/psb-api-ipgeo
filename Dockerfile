FROM myrotvorets/node-build:latest@sha256:eebd2c8e194c3f431272637a822a192555d074a7abf671f33f40982758eeef32 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:d948095949721fd207ad8a0eafb58740c05e40901aa12611182056a8c3b97c5f
USER root
WORKDIR /srv/service
RUN \
