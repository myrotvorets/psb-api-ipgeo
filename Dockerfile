FROM myrotvorets/node-build:latest@sha256:50608c599be48865550e65c896c051ad8b792f3df1a2149d52ac6952d1cb279d AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:a7fcae6c7e4a504f730df44115105c975e95ccc668b896dc5f97dd464f499384
USER root
WORKDIR /srv/service
RUN \
