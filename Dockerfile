FROM myrotvorets/node-build:latest@sha256:8fe8ea9a934bbf13bbcce9049b2f79547f9099527370bdeceedc7f014ff82959 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:6014bfc9bd5c7d968c7d78f888f231d0212328cba4ebef2095e5f09c6a93419f
USER root
WORKDIR /srv/service
RUN \
