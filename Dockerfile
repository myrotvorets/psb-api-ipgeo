FROM myrotvorets/node-build:latest@sha256:962f8e79f5cac8493b639ba5bc7fe8e0b3334434189e3c834381ce027e755d01 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:194ad9ebdf11cd4f8843c1375d4bbe7dab6e3c661924cb34a91e24f03b87301e
USER root
WORKDIR /srv/service
RUN \
