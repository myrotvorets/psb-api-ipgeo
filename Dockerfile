FROM myrotvorets/node-build:latest@sha256:a511315ca00b8764255e1d241a99d5b759a7a946c96fb2ce539e7863c4315033 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:fe7a4557f9e4f6aebefbd255ae50d16560583b7c2457073c86e20bb5fb36d0bb
USER root
WORKDIR /srv/service
RUN \
