FROM myrotvorets/node-build:latest@sha256:533b2abb93a37bd7b78fe8689d695a8a522e070c87791f6d62deb1e0db57c1c8 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:684ff3c0755a6fa1c68dce39ac88533976190be60d02af290aca08e9aba2e595
USER root
WORKDIR /srv/service
RUN \
