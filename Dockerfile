FROM myrotvorets/node-build:latest@sha256:937f8aca2e0a504732c9ee599d9f942fc0bb610c91052d3c0bb9ad6f64e473bf AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:2fd4b09cb7bab250a6a64759bae10da140fcb41f953be46264c9de48a7975c16
USER root
WORKDIR /srv/service
RUN \
