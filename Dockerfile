FROM myrotvorets/node-build:latest@sha256:9da83bebdda24996f2b8055d50f03dafaffb6688f974d37328abb4de2d16270f AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:97c5d994870f961f0107fd53afe668cc9006b25e83a655883235c1c07587d9f7
USER root
WORKDIR /srv/service
RUN \
