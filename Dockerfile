FROM myrotvorets/node-build:latest@sha256:856c8c4754af0fe40323e769f5e24dc3883fcc12fa460c1a1abc9b8bbf2d33fd AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:711be8f0f0f02acd1498927ca9fc505eb25c1c543ec5371413b4912ff20fcd77
USER root
WORKDIR /srv/service
RUN \
