FROM myrotvorets/node-build:latest@sha256:06c95d24f4db84034b6b80b6feffe3897937d75895771725eb176cde36c67717 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:8b97d0d7cbda5ef8fc4fab2f24d45b144fdf425ce1e4b8935ce2d5fe08f9b150
USER root
WORKDIR /srv/service
RUN \
