FROM myrotvorets/node-build:latest@sha256:0125f6828a67e6ade81ff5929bd988e9ce27c99fbbb1601e15a594e3b49c78e2 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:d1647736758c22507c8804924165062b228a8aa0d18fcdc5350eaae845887fbc
USER root
WORKDIR /srv/service
RUN \
