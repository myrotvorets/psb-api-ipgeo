FROM myrotvorets/node-build:latest@sha256:73038fd3ce1a29b788981d88fd0253661af8cfb4cd5354d6534f40d196b224de AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:904def01fa41a47e8978db2e3ada1be4c03663760e207ac0ef579d8f88a02f43
USER root
WORKDIR /srv/service
RUN \
