FROM myrotvorets/node-build:latest@sha256:e6f2a150e1978da3baa0e43d2bed7f475b3eaf0e3ae0ab1eb0f278120f4aeba1 AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:78678d08f87310c1af3050d447bad9f7ec96b4bdf964bbcd8c61ae93a13b612d
USER root
WORKDIR /srv/service
RUN \
