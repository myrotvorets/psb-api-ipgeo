FROM myrotvorets/node-build:latest@sha256:ae0adf3dad63ec34a01e436dadffc762baa6b5f7c76d9be5473f4dd3f436ca0c AS build
USER root
WORKDIR /srv/service
...
FROM myrotvorets/node-min@sha256:83058dcf976ba7bc90e115a14f3adc8830fea91065c3afe8d50ea2309f9a71f4
USER root
WORKDIR /srv/service
RUN \
